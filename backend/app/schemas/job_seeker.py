...
class JobSeekerProfileUpdate(BaseModel):
    ...
    study_status: str = Field(default="", max_length=50)
    graduation_year: str = Field(default="", max_length=10)
    ...
    availability: str = Field(default="", max_length=50)
    skills: list[str] = Field(default_factory=list)
    projects: list[str] = Field(default_factory=list)


class JobSeekerProfileResponse(JobSeekerProfileUpdate):
    user_id: int
