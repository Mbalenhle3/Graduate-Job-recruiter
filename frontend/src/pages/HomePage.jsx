...
export default function HomePage() {
  return <div className="public-page role-home">
    <header className="public-header"><div className="public-nav"><Logo/><nav><a href="#roles">Choose account</a><a href="#about"></a></nav><div className="header-actions"><Link to="/auth/job-seeker/signin"></Link></div></div></header>
    <main>
      ...
      <section id="about" className="home-process"><p>Job seekers apply, employers recruit, and administrators keep the platform trusted.</p></section>
    </main>
