...
import GradBot from "./components/common/GradBot";
import AppealPage from "./pages/auth/AppealPage";
...
export default function App() {
  ...
  return <><Routes>
    ...
    <Route path="/admin/support" element={protectedPage("admin", <SupportRequestsPage />)} />
    <Route path="/admin/appeals" element={protectedPage("admin", <AppealsPage />)} />
